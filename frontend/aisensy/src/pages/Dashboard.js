        ...
        >
          <nav className="p-4">
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/connect-whatsapp" className="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition group">
                  ...
                  <span className={sidebarOpen ? 'block' : 'hidden md:block'}>Connect WhatsApp</span>
                </Link>
              </li>
              <li>
